 ...
 * of the current transaction, see {@link #asList()}.
 */
public interface Result extends RecordView, Resource
{
    /**
    ...
    /**
     * Move to the last record if possible, otherwise do nothing
     *
     * @return true if the cursor was successfully placed at the last record
     */
    boolean last();
